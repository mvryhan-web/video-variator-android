const CACHE='video-variator-v5';
const APP_SHELL=['/','/index.html','/styles.css','/v3.css','/app-v4.js','/video-core.js','/bootstrap.js','/admin-access.js','/manifest.webmanifest','/icon.svg'];
