const CACHE='video-uniquifier-v22';
const APP_SHELL=['/','/index.html','/styles.css','/v3.css','/v5.css','/product-polish.css','/auth-email.css','/app-v4.js','/app-v5.js','/product-polish.js','/auth-email.js','/video-core.js','/bootstrap.js','/trial-quality.js','/admin-access.js','/ffmpeg-worker.js','/manifest.webmanifest','/icon.svg','/free-tools.html','/free-tools.js','/free-tools.css','/theme.js','/theme.css','/file-share.js'];
