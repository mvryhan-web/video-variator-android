const CACHE='video-uniquifier-v13';
const APP_SHELL=['/','/index.html','/styles.css','/v3.css','/v5.css','/app-v4.js','/app-v5.js','/video-core.js','/bootstrap.js','/trial-quality.js','/admin-access.js','/ffmpeg-worker.js','/manifest.webmanifest','/icon.svg','/icon-180.png','/icon-192.png','/icon-512.png'];
...
self.addEventListener('fetch',event=>{
  ...
  // Account responses must never be stored or replayed from the offline cache.
